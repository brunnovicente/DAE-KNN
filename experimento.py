...
for k in np.arange(10):
    ...
    X_train, X_test, y_train, y_test = train_test_split(X,Y, train_size=0.1, test_size=0.9, stratify=Y)
    ...
    for r,p in enumerate(porcentagem):
        ...
        for j in np.arange(10):
            ...
            L, U, y, yu = train_test_split(X_train, y_train, train_size = p, test_size= 1 - p, stratify=y_train)
